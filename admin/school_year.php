                ...
                <div class="row-fluid">
                    ...
                    <div id="block_bg" class="block">
                        <div class="navbar navbar-inner block-header">
                            <div class="muted pull-left">Daftar Tahun Ajaran</div>
                        </div>
                            ...
                            <div class="span12">
                                <form action="delete_sy.php" method="post">
                                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                                        <a data-toggle="modal" href="#user_delete" id="delete" class="btn btn-danger" name="">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td width="40">
                                                        <a href="edit_user.php?id=<?php echo $id; ?>" data-toggle="modal" class="btn btn-success">
