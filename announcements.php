						...
						<div class="block-content collapse in">
							<div class="span12">
								<form method="post">
									...
									<br>
									<button name="post" class="btn btn-info"><i class="icon-check icon-large"></i> Kirim</button>
								</form>
							</div>
							...
							if (isset($_POST['post'])) {
								...
								mysqli_query($conn, "insert into notification (teacher_class_id,notification,date_of_notification,link) value('$get_id','Tambah Pengumuman',NOW(),'announcements_student.php')") or die(mysqli_error($conn));
							?>
								<script>
									...
									<div class="post" id="del<?php echo $id; ?>">
										...
										<div class="pull-right">
											<form method="post" action="edit_post.php<?php echo '?id=' . $get_id; ?>">
												...
												<button class="btn btn-link" name="edit"><i class="icon-pencil"></i> Edit</button>
											</form>
										</div>
					...
					$('.remove').click(function() {
						...
						$.ajax({
							...
							success: function(html) {
								...
								$('#' + id).modal('hide');
								$.jGrowl("Pengumuman Anda Berhasil Dihapus", {
									header: 'Data Dihapus'
								});
