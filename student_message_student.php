                            ...
                            <div class="span12">
                                <form action="read_message.php" method="post">
                                    <div class="pull-right">
                                        <button class="btn btn-info" name="read"><i class="icon-check"></i> Tandai Dibaca</button>
                                    ...
                                    <ul class="nav nav-pills">
                                        <li class="active"><a href="student_message.php"><i class="icon-envelope-alt"></i>Kotak Masuk</a></li>
                                    ...
                                    if ($count_my_message != '0') {
                                        ...
                                        <div class="alert alert-info"><i class="icon-info-sign"></i> Tidak Ada Pesan di Kotak Masuk</div>
                                    <?php } ?>
                                </form>
                            </div>
                        </div>
                        ...
                        $('.remove').click(function () {
                            ...
                            $.ajax({
                                ...
                                success: function (html) {
                                    ...
                                    $('#' + id).modal('hide');
                                    $.jGrowl("Pesan yang Anda kirim berhasil dihapus", { header: 'Data Dihapus' });
                                }
                            });
                            return false;
                        });
