            ...
            <div class="span6" id="content">
                <div class="row-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#"><b>Materi Unduhan</b></a></li>
                    </ul>
                    <!-- end breadcrumb -->
                    ...
                    <div id="block_bg" class="block">
                        ...
                        <div class="block-content collapse in">
                            <div id="downloadable_table.php" class="span12">
                                ...
                                if ($count == 0) { ?>
                                    <div class="alert alert-info"><i class="icon-info-sign"></i> Saat ini Anda belum mengunggah materi unduhan apa pun</div>
                                <?php } else { ?>
                                    <form action="copy_file.php" method="post">
                                        <a data-toggle="modal" href="#user_delete" id="delete" class="btn btn-info" name="">
                                            <i class="icon-file"></i> Salin Item yang Dipilih
                                        </a>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr id="del<?php echo $id; ?>">
                                                        ...
                                                        <td width="40">
                                                            <a data-placement="bottom" title="Unduh" id="<?php echo $id; ?>download" href="<?php echo $row['floc']; ?>">
                                                                <i class="icon-download icon-large"></i>
                                                            </a>
                                                            <a data-placement="bottom" title="Hapus" id="<?php echo $id; ?>remove" href="#<?php echo $id; ?>" data-toggle="modal">
                        ...
                        $('.remove').click(function() {
                            ...
                            $.ajax({
                                ...
                                success: function(html) {
                                    ...
                                    $('#' + id).modal('hide');
                                    $.jGrowl("Data berhasil dihapus", { header: 'Hapus Data' });
                                }
                            });
                            return false;
                        });
