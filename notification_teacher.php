                            ...
                            <div class="span12">
                                ...
                                <form id="domainTable" action="read_teacher.php" method="post">
                                    <?php if ($not_read == '0') {} else { ?>
                                        <button id="delete" class="btn btn-info" name="read"><i class="icon-check"></i> Tandai Sebagai Dibaca</button>
                                    <?php } ?>
                                    ...
                                    ?>
                                        <div class="post" id="del<?php echo $id; ?>">
                                            ...
                                            <?php echo $row['notification']; ?> Di <b><?php echo $row['fname']; ?></b>
