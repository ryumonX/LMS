			...
			<div class="span9" id="content">
				<div class="row-fluid">
					...
					<div class="pull-right">
						<a href="my_students.php<?php echo '?id=' . $get_id; ?>" class="btn btn-info"><i class="icon-arrow-left"></i> Kembali</a>
					</div>
					...
					<ul class="breadcrumb">
						...
						<li><a href="#">Siswa Saya</a><span class="divider">/</span></li>
						<li><a href="#"><b>Tambah Siswa</b></a></li>
					</ul>
						...
						<div class="block-content collapse in">
							<div class="span12">
								<form method="post" action="">
									...
									<button name="submit" type="submit" class="btn btn-info"><i class="icon-save"></i>&nbsp;Tambah Siswa</button>
									<br>
									<br>
