            ...
            <div class="span6" id="content">
                <div class="row-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#"><b>Tugas yang Diupload</b></a></li>
                    </ul>
                    <!-- end breadcrumb -->
                    <!-- block -->
                    <div id="block_bg" class="block">
                        ...
                        <div class="block-content collapse in">
                            <div class="span12">
                                <!-- Add a wrapper div with scroll functionality -->
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="150">
                                                        <form method="post" action="view_submit_assignment.php<?php echo '?id=' . $get_id ?>&<?php echo 'post_id=' . $id ?>">
                                                            ...
                                                            <button data-placement="bottom" title="Lihat Siswa yang Mengumpulkan Tugas" id="<?php echo $id; ?>view" class="btn btn-success"><i class="icon-folder-open-alt icon-large"></i></button>
                                                        ...
                                                        ?>
                                                            <a data-placement="bottom" title="Unduh" id="<?php echo $id; ?>download" class="btn btn-info" href="<?php echo $row['floc']; ?>"><i class="icon-download icon-large"></i></a>
                                                        <?php } ?>
                                                        <a data-placement="bottom" title="Hapus" id="<?php echo $id; ?>remove" class="btn btn-danger" href="#<?php echo $id; ?>" data-toggle="modal"><i class="icon-remove icon-large"></i></a>
