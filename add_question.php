			...
			<div class="span9" id="content">
				<div class="row-fluid">
					...
					<ul class="breadcrumb">
						...
						<li><a href="#"><b>Pertanyaan Ujian</b></a></li>
					</ul>
					<!-- end breadcrumb -->
					<!-- block -->
						...
						<div class="block-content collapse in">
							<div class="span12">
								...
								<form class="form-horizontal" method="post">
									...
									<!-- <div class="control-group">
											<label class="control-label" for="inputEmail">Poin</label>
											<div class="controls">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<div id="opt12">
												<input name="correctt" value="True" type="radio">Benar<br /><br />
												<input name="correctt" value="False" type="radio">Salah<br /><br />
											</div>
										</div>
									</div>
